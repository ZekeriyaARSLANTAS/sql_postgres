...
select * from isciler order by maas desc limit 1 ;              -- Column a nasıl "en_yuksek_maas" yazdırırız? 
-- 4) Isciler tablosunda ikinci en yuksek maasi maasi gosteren query yazin
select max(maas) AS enyuksek_ikinci_maas from isciler
...
select * from isciler order by maas desc limit 1 offset 1;      -- Column a nasıl "en_yuksek_ikinci_maas" yazdırırız?
